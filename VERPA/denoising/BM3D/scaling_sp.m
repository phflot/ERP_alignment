function [x,res] = scaling_sp(A,tol)
% A balancing algorithm for symmetric matrices
% code from reference : P. A. Knight and D. Ruiz, “A fast algorithm for matrix balancing,”
%IMA J. Numer. Anal., vol. 33, pp. 1029–1047, 2013.
% X = scaling_sp(A) attempts to find a vector X such that
